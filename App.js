...
const resData = [
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2023-11-06 06:00:00",
                "opened": true
            },
            "badges": {
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2023-11-06 05:00:00",
                "opened": true
            },
            "badges": {
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2023-11-06 02:59:00",
                "opened": true
            },
            "badges": {
    ...
    },
    {
        ...
        "cta": {
            "link": "https://www.swiggy.com/restaurants/the-brooklyn-creamery-healthy-ice-cream-c-block-janakpuri-delhi-367665",
            "type": "WEBLINK"
        }
    },
    {
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2023-11-06 03:30:00",
                "opened": true
            },
            "badges": {
                "imageBadges": [
    ...
    return (
        <div style={navStyling}>
            <div style={{ display: "flex", alignItems: "center" }}>
                <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_284/Logo_f5xzza" alt="logo" width="50px" height="50px" />
                <h1 style={{ marginLeft: "10px" }}>Swiggy</h1>
            </div>
            <div style={{ display: "flex", alignItems: "center" }}>
                <h3 style={{ marginRight: "10px" }}>Login</h3>
                <button style={{ backgroundColor: "#fc8019", color: "white", border: "none", padding: "10px", borderRadius: "5px" }}>Sign Up</button>
            </div>
        </div>
    )
}
...
const RestaurantCard = ({ resData }) => {
    ...
    return (
        <div style={styleCard} className="res-card">
            <img className="res-pic" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId} alt="restaurant" />
